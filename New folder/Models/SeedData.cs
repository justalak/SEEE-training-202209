...
namespace MySchool.Models
{
    public class SeedData
    {
        ...
        {
            using (var contextSt = new ManagerStudentContext
                (serviceProvider.GetRequiredService<DbContextOptions<ManagerStudentContext>>()))
            {
            ...
            //using (var contextTc = new ManagerTeacherContext
            //    (serviceProvider.GetRequiredService<DbContextOptions<ManagerTeacherContext>>()))
            //{
            //    if (contextTc.Teachers.Any())
            //    {
            //        return;
            //    }
            //    contextTc.Teachers.AddRange(
            //       new Teacher
            //       {
            //           NameTeacher = "Quinn Ramsdell",
            //       },
            //       new Teacher
            //       {
            //           NameTeacher = "Octavius Manjot"
            //       },
            //       new Teacher
            //       {
            //           NameTeacher = "Layton Petters"
            //       },
            //       new Teacher
            //       {
            //           NameTeacher = "Donnie Crowley"
            //       },
            //       new Teacher
            //       {
            //           NameTeacher = "Tanitansy Kliemchen"
            //       }
            //    );
            //}
            //using (var contextTc = new ManagerClassContext
            //    (serviceProvider.GetRequiredService<DbContextOptions<ManagerClassContext>>()))
            //{
            //    if (contextTc.Classes.Any())
            //    {
            //        return;
            //    }
            //    contextTc.Classes.AddRange(
            //       new Class
            //       {
            //           NameClass = "A1",
            //           IdTeacher = 1
